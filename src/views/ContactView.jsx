...
export const ContactView = () => {
    ...
    return (
        <section className="w-full min-h-screen bg-[#f0e9d8] px-4 py-10 flex flex-col items-center">
            <div className="max-w-2xl text-center mb-10" data-aos="fade-up" data-aos-duration="800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-10 -mt-4 w-full max-w-3xl" data-aos="fade-up" data-aos-delay="100" data-aos-duration="800">
